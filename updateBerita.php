          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  Update Berita
                  <small>Update berita dan kuasai dunia!</small>
                </h3>
                <!-- tools box -->
            ...
            <!-- /.card-header -->
              <div class="card-body">
                <div class="mb-3">
                  <form action="database/updateBerita.php?id=<?php echo $row["id_berita"]; ?>" method="post" enctype="multipart/form-data">
                    <b>Gambar Berita</b><br>
                    <input type="file" name="gbr_berita" value="Gambar Berita"><br><br>
                    <input type="text" name="judul" placeholder="Judul" class="form-control" value="<?php echo $row["judul"]; ?>"><br>
                    <textarea id="editor1" name="isi_berita" style="width: 100%;"><?php echo $row["isi_berita"]; ?></textarea><br>
